...
INSERT_BLOCK = "INSERT INTO blocks (height, size, weight, difficulty, cumulative_difficulty, hash, long_term_weight, major_version, minor_version, nonce, reward, timestamp, wide_cumulative_difficulty, wide_difficulty) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
INSERT_TRANSACTION = "INSERT INTO transactions (version, hash, fee, height, unlocktime) VALUES (%s, %s, %s, %s, %s, %s)"
INSERT_TXIN = "INSERT INTO txins (tx_id, amount, keyimage) VALUES (%s, %s, %s)"
...
INSERT_OUTPUT_DETAILS = "INSERT INTO output_details (txin_id, height, key_hex, mask_hex, unlocked) VALUES (%s, %s)"

def insert_transaction(conn: MySQLConnection, block: Block, t: Transaction):
    c = conn.cursor()
    try:
        b = block
...
#        hash_value = int(t.hash_hex, 16)
            ...
            for tx_in in t.tx_ins:
                c.execute(INSERT_TXIN, (t.tx_id, tx_in.amount, tx_in.key_image))
